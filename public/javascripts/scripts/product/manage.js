...
Product.manage.table.render = (products, pageSize, page, location) => {
	var html = "<tr>";
	html += "<td>Cód</td>";
	html += "<td>Nome</td>";
	html += "<td>Tamanho</td>";
...
Product.manage.table.info = (product) => {
	let html = "";
	...
	document.getElementById("product-manage-show-table").innerHTML = html;
};
